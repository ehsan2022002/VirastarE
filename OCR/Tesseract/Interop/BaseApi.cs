...
namespace Tesseract.Interop
{
    ...
    public interface ITessApiSignatures
    {
        ...
        [RuntimeDllImport(Constants.TesseractDllName, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "TessDeleteBlockList")]
    ...
    internal static class TessApi
    {
        ...
        {
            Guard.Require("handle", handle.Handle != IntPtr.Zero,
            ...
            foreach (var pair in initialValues)
            {
                ...
                Guard.Require("initialValues", pair.Value != null, "Variable '{0}': The type '{1}' is not supported.",
