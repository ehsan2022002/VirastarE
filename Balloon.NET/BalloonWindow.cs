...
namespace Balloon.NET
{
	...
	public class BalloonWindow : System.Windows.Forms.Form
	{
        ...
        public static Point PointFromControl(Point PointControl, Size SizeControl,Point LocationScreen)
        {
            if (PointControl == null)
                throw new ArgumentException();

            Point controlLocation = PointControl;
            System.Drawing.Size controlSize = SizeControl;

            if (LocationScreen != null)
                controlLocation =LocationScreen;
        ...
        public void ShowBallonPoint(Point PointControl, Size SizeControl, Point LocationScreen)
        {
            this.anchorPoint = PointFromControl(PointControl, SizeControl, LocationScreen);
            this.Show();
        }

        public void ShowBallonScreen(Point LocationScreen)
        {
            ShowBallonPoint(new Point(20, 20), new Size(10, 10), LocationScreen);
        }
